...
<html lang="zxx">
  <head>
    ...
    <style>
      ...
      .hero-card h1{ font-size:clamp(26px,4vw,44px); line-height:1.08; margin:6px 0 10px; color:#fff; font-weight:800; }
        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">Heavy Duty Racks</h1>
              <p>High-strength storage systems for optimized space, safety, and throughput.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 pr-45 md-pr-15" data-animate>
              <div class="prod-media">
                <img
                  src="assets/images/products/packing-and-grading-line.webp"
                  alt="Heavy duty pallet racking for warehouses and cold stores"
                  width="1200" height="800" loading="lazy" decoding="async">
              </div>

              <h2 class="h2">Key Product Features</h2>
              <p class="lead">
                Heavy-duty racks of Singhania Refrigeration are manufactured to give maximum strength, safety, and space optimization for warehouses and cold storage facilities, as well as logistics hubs in Delhi, Pune, Ahmedabad, and Noida. These racks are made of high-grade certified steel, making them ideal for businesses operating in Delhi NCR, Gurugram, Faridabad, and Ghaziabad, with superior load-bearing capacity and long-term structural integrity.
              </p>

              <div class="card-lite mt-20">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Highlights</h4>
                <ul class="feature-list">
                  <li>Selective, drive-in, and shuttle-ready configurations to suit varied storage requirements.</li>
                  <li>High load capacities built with certified steel grades for long-term durability.</li>
                  <li>Galvanized options suitable for low-temperature and high-humidity cold rooms.</li>
                  <li>Safety features including anti-collapse mesh, protective guards &amp; labeling systems.</li>
                  <li>Modular expansion with quick on-site assembly for flexible future upgrades.</li>
                </ul>
                <div class="cta-bar">
              ...
              <div class="project-sidebar">
                <div class="sb-project-detail">
                  ...
                  <ul>
                    ...
                    <li><a class="active" href="heavy-duty-racks.php">Heavy Duty Racks</a></li>
