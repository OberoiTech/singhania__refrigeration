        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">Transport Refrigeration</h1>
              <p>Refrigeration solutions for small &amp; medium trucks and vans—fresh and frozen logistics with direct-drive, battery, split &amp; monoblock options.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 pr-45 md-pr-15" data-animate>
              <div class="feature-media">
                <img
                  ...
                  alt="Transport refrigeration for vans and trucks"
            ...
            <div class="col-lg-7 md-mb-50 md-order-first" data-animate>
              <h2 class="h2">Built for Fresh &amp; Frozen Distribution</h2>
              <p class="lead">
                We deliver refrigeration solutions for medium/small storage trucks &amp; vans, across fresh and frozen applications.
              </p>

              <div class="card-lite mt-16">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">System Options</h4>
                <ul class="checklist">
                  <li><strong>Battery units:</strong> Silent, urban-friendly last-mile deliveries</li>
                  <li><strong>“Invisible” units:</strong> Compact integration with minimal exterior footprint</li>
                  <li><strong>Direct-drive units:</strong> Engine-powered, efficient for daily routes</li>
                  <li><strong>Configurations:</strong> Split &amp; monoblock variants</li>
                  <li><strong>Body sizes:</strong> Suited for small &amp; medium insulated bodies</li>
                </ul>
                <div class="cta-bar">
                  <a href="contact.php" class="btn-brand">Request a Quote</a>
                  <!-- <a href="assets/brochures/transport-refrigeration.pdf" class="btn-brand" target="_blank" rel="noopener">Download Brochure</a> -->
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row mt-30">
            <div class="col-12" data-animate>
              <div class="card-lite">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Why Choose Us</h4>
                <ul class="checklist">
                  <li>Optimized for both fresh (chilled) and frozen temperature bands</li>
                  <li>Energy-efficient components for lower total cost of ownership</li>
                  <li>Reliable after-sales support and spare parts availability</li>
                  <li>Compliance-ready installations with audit trails &amp; documentation</li>
                </ul>
              </div>
            </div>
          </div>

          <!-- Context note / intro (optional) -->
          <div class="row mt-30">
            <div class="col-12" data-animate>
              <div class="card-lite">
                <p class="mb-0" style="color:#2d3c63;">
                  We provide “End to End Integrated Cold Chain Solution”, undertaking Cold Storage Facility projects such as
                  Turnkey Construction, Cold Chain Refrigeration Systems, Consulting, Transport Refrigeration Systems,
                  Packing &amp; Grading Lines, and quality monitoring solutions for multiple applications and segments.
                </p>
              </div>
            </div>
          </div>
