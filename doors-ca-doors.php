        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">Doors &amp; CA Doors</h1>
              <p>Durable, insulated doors with precision sealing for energy-efficient cold rooms.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-8 pr-45 md-pr-15" data-animate>
              <div class="prod-media">
                <img
                  ...
                  alt="Insulated cold room doors and CA doors"
                  width="1200" height="800" loading="lazy" decoding="async">
              </div>

              <h2 class="h2">Key Product Features</h2>
              <p class="lead">
                Singhania Refrigeration Doors &amp; CA Doors in Delhi have been manufactured to provide you with a premium insulation solution for your cold storage, CA room, or refrigerated unit. Being a reliable supplier of cold storage doors in Delhi, we guarantee maximum efficiency, excellent sealing ability, and durable construction.
              </p>

              <div class="card-lite mt-20">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Highlights</h4>
                <ul class="feature-list">
                  <li>Sliding &amp; hinged variants available for chiller, freezer and CA room applications.</li>
                  <li>High-performance sealing systems mitigate frost formation and leakage.</li>
                  <li>Heated frames and thresholds are designed for reliable operation in low-temperature environments.</li>
                  <li>Food-safe finishes and easy-clean hardware ensure hygiene and compliance.</li>
                  <li>Custom sizes are available, featuring safety systems and view apertures to ensure operational safety and flexibility.</li>
                </ul>
                <div class="cta-bar">
              ...
              <div class="project-sidebar">
                <div class="sb-project-detail">
                  ...
                  <ul>
                    ...
                    <li><a class="active" href="doors-ca-doors.php">Doors &amp; CA Doors</a></li>
