        ...
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active">
                    <a href="add-products.php" class="btn btn-primary btn-sm">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    ...
                                    while ($result = mysqli_fetch_assoc($row)) {
                                        ...
                                        // Description might contain HTML from CKEditor;
                                        // show a clean short text + full tooltip
                                        $fullDesc  = strip_tags($result['description']);
                                        $shortDesc = substr($fullDesc, 0, 140);
                                        if (strlen($fullDesc) > 140) {
                                            $shortDesc .= '...';
                                        }
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-products.php?id=<?php echo (int)$result['id']; ?>"
                                               class="btn btn-success btn-sm"
                                               title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="delete.php?id=<?php echo (int)$result['id']; ?>&type=products"
