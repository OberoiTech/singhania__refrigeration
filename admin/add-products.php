    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($name !== '' && $description !== '') {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $path)) {
                ...
                $rs = "INSERT INTO products (title, description, image) VALUES (
                ...
                if ($result) {
                    echo "<script>alert('Success: Record Added Successfully');window.location.href='products-details.php';</script>";
                    exit;
                } else {
        ...
        $color = "alert alert-danger";
        $msg   = "Please choose a product image.";
    }
}
?>
<!DOCTYPE html>
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-archive"></i> Add Product</h1>
            </div>
