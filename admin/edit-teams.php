...
$query = mysqli_query($conn, "SELECT * FROM teams WHERE id = '$id'");
$row   = mysqli_fetch_assoc($query);

if (!$row) {
    echo "<script>alert('Error: Team member not found');window.location.href='teams-details.php';</script>";
    exit;
}
...
if (isset($_POST['submit'])) {
    ...
    if ($name === '' || $designation === '') {
        ...
        if ($msg === '') {
            ...
            if ($result) {
                echo "<script>alert('Success: Record Updated Successfully');window.location.href='teams-details.php';</script>";
                exit;
            } else {
                $color = "alert alert-danger";
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-user"></i> Edit Team Member</h1>
            </div>
