        ...
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active">
                    <a href="add-services.php" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-services.php?id=<?php echo (int)$result['id']; ?>"
                                                   class="btn btn-success btn-sm" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="delete.php?id=<?php echo (int)$result['id']; ?>&type=services"
