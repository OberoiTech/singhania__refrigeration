        ...
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active">
                    <a href="add-banners.php" class="btn btn-primary btn-sm">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    ...
                                    $query = "
                                        ...
                                        FROM banners b
                                        JOIN menus m ON b.menu_name = m.id
                                        ORDER BY b.id DESC
                                    ";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($result['image'])) : ?>
                                                <img class="sr-banner-thumb"
                                                     src="<?php echo 'uploads/' . htmlspecialchars($result['image']); ?>"
                                                     alt="<?php echo htmlspecialchars($result['menu_title']); ?>">
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo htmlspecialchars($result['created_at']); ?></td>
                                        <td>
                                            <a href="edit-banners.php?id=<?php echo (int)$result['id']; ?>"
                                               class="btn btn-success btn-sm"
                                               title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="delete.php?id=<?php echo (int)$result['id']; ?>&type=banners"
