        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">Cold Chain Refrigeration, CA Store, Freon/Ammonia</h1>
              <p>End-to-end integrated cold chain solutions—Turnkey construction, refrigeration systems, consulting, transport refrigeration, packing &amp; grading lines, and quality monitoring.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 pr-45 md-pr-15" data-animate>
              <div class="turnkey-media">
                <img
                  src="assets/images/products/cold-room-doors.webp"
                  alt="Cold chain refrigeration and CA store solutions"
            ...
            <div class="col-lg-7 md-mb-50 md-order-first" data-animate>
              ...
              <div class="card-lite mt-16">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Material Supply, Installation &amp; Commissioning</h4>
                <ul class="checklist">
                  <li><strong>Envelope:</strong> Prefab PUF Panels, automated/manual sliding &amp; swing doors, CA doors</li>
                  <li><strong>Air Systems:</strong> High CFM &amp; humidity slim/cubic indoor units, industrial evaporators</li>
                  <li><strong>Refrigeration:</strong> Compressor racks, microprocessor controllers, condensing units</li>
                  <li><strong>Handling &amp; Storage:</strong> Racking, internal mezzanine, bins for storage</li>
                  <li><strong>Dock &amp; Access:</strong> Dock levelers, dock shelters, overhead sectional doors</li>
                  <li><strong>Condensers &amp; Structure:</strong> Air/Water-cooled condensers, PEB structures</li>
                  <li><strong>Refrigerants:</strong> Solutions based on <em>Freon</em> / <em>Ammonia</em></li>
                  <li><strong>Special Facility:</strong> Controlled Atmosphere (CA) Store</li>
                </ul>
                <div class="cta-bar">
                  <a href="contact.php" class="btn-brand">Request a Site Visit</a>
                  <!-- <a href="assets/brochures/cold-chain-refrigeration.pdf" class="btn-brand" target="_blank" rel="noopener">Download Brochure</a> -->
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row mt-30">
            <div class="col-12" data-animate>
              <div class="card-lite">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Our Process</h4>
                <ul class="checklist">
                  <li>Consultation, feasibility &amp; ROI modeling</li>
                  <li>Detailed engineering, layouts &amp; compliance</li>
                  <li>Coordinated procurement &amp; site execution</li>
                  <li>Commissioning, validation &amp; handover</li>
                  <li>AMC &amp; performance monitoring for uptime &amp; energy</li>
                </ul>
              </div>
            </div>
          </div>
