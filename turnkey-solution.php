        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">Turnkey Solutions</h1>
              <p>End-to-end integrated cold chain projects—from concept & design to commissioning and AMC.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-5 pr-45 md-pr-15" data-animate>
              <div class="turnkey-media">
                <img
                  src="assets/images/products/turnkey-cold-storage-project.webp"
                  alt="Turnkey cold storage project execution"
            ...
            <div class="col-lg-7 md-mb-50 md-order-first" data-animate>
              ...
              <div class="card-lite mt-16">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">What’s Included</h4>
                <ul class="checklist">
                  <li><strong>Consulting &amp; Design:</strong> Concept, layout, heat-load, BOQs, budgets &amp; compliance docs</li>
                  <li><strong>Civil &amp; PEB:</strong> Civil works, PEB structure, floors, drainage, utilities</li>
                  <li><strong>Electrical &amp; Controls:</strong> Panels, cabling, lighting, safety &amp; automation</li>
                  <li><strong>Refrigeration:</strong> Freon/Ammonia systems, compressor racks, evaporators, condensers</li>
                  <li><strong>Specialized Units:</strong> IQF tunnels, ripening rooms, blast freezing</li>
                  <li><strong>Envelope:</strong> PUF panels, insulated doors, dock shelters &amp; levelers</li>
                  <li><strong>Process:</strong> Packing &amp; grading lines, material handling &amp; racking</li>
                  <li><strong>Quality &amp; IoT:</strong> Sensors, data logging, alarms &amp; audit trails</li>
                </ul>
                <div class="cta-bar">
                  <a href="contact.php" class="btn-brand">Request a Site Visit</a>
                  <!-- <a href="assets/brochures/turnkey-solution.pdf" class="btn-brand" target="_blank" rel="noopener">Download Brochure</a> -->
                </div>
              </div>
            </div>
          </div>

          <!-- Optional secondary section: Process steps -->
          <div class="row mt-30">
            <div class="col-12" data-animate>
              <div class="card-lite">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Our Process</h4>
                <ul class="checklist">
                  <li>Discovery &amp; feasibility study with ROI modeling</li>
                  <li>Detailed engineering, approvals &amp; project plan</li>
