...
<html lang="en">
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs bg-7">
                <div class="container">
                    <div class="content-part text-center pt-160 pb-160">
                        <h1 class="breadcrumbs-title white-color mb-0">Warehousing Equipment's</h1>
                    </div>
                </div>
            </div>
            ...
            <div id="rs-portfolio" class="rs-portfolio single pt-10 md-pt-80 pb-10 lg-pb-92 md-pb-72">
                <div class="container">
                    <div class="row">
