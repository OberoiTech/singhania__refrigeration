        ...
        <div class="container">
          <div class="content-part">
            <div class="hero-card">
              ...
              <h1 class="mb-10">PUF Panels</h1>
              <p>High-performance insulated panels for energy-efficient cold rooms and warehouses.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-8 pr-45 md-pr-15" data-animate>
              <div class="prod-media">
                <img
                  ...
                  alt="PUF insulated panels for cold rooms"
                  width="1200" height="800" loading="lazy" decoding="async">
              </div>

              <h2 class="h2">Key Product Features</h2>
              <p class="lead">
                The PUFF insulated panels produced and offered by Singhania Refrigeration in Delhi have been specifically engineered to provide superior insulating properties as well as high durability and strength in a number of applications, including cold storage rooms, warehouses, food processing plants, pharmaceutical facilities, and clean rooms in the Delhi NCR area. We are one of the reputed producers and suppliers of PUFF insulated panels in Delhi and focus on satisfying the requirements for energy-efficient cold storage in Delhi.
              </p>

              <div class="card-lite mt-20">
                <h4 class="mb-10" style="font-weight:800;color:var(--ink);">Highlights</h4>
                <ul class="feature-list">
                  <li>High R-value with precision tongue-and-groove joints for excellent thermal insulation.</li>
                  <li>Durability and hygiene conformance are guaranteed by food-grade skins and anti-corrosion coatings.</li>
                  <li>Custom thicknesses are available to accommodate the specifications of both freezer rooms and chillers.</li>
                  <li>Fast, clean installation with minimal thermal bridging for maximum efficiency.</li>
                  <li>Compatible with doors, windows &amp; MEP penetrations for seamless integration.</li>
                </ul>
                <div class="cta-bar">
              ...
              <div class="project-sidebar">
                <div class="sb-project-detail">
                  ...
                  <ul>
                    ...
                    <li><a class="active" href="panels.php">PUF Panels</a></li>
